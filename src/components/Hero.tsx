  ...
  return (
    <section className="pt-24 md:pt-32 pb-16 md:pb-24 relative overflow-hidden">
      <div 
        ...
        style={{ 
          backgroundImage: "url('https://images.pexels.com/photos/3847486/pexels-photo-3847486.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')" 
        }}
      ></div>
      <div 
        className="absolute inset-0 bg-gradient-to-r from-red-800/90 to-red-700/70 z-0"
      ></div>
        ...
        <div className="flex flex-col lg:flex-row items-center">
          <div className="w-full lg:w-1/2 text-center lg:text-left mb-10 lg:mb-0">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight mb-6">
              ChefComanda: O sistema inteligente para comandas e pedidos no seu restaurante
            </h1>
            <p className="text-lg md:text-xl text-white/90 mb-8 max-w-2xl mx-auto lg:mx-0">
              Controle de mesas, pedidos e cozinha de forma simples, rápida e integrada com iFood.
            </p>
            <a 
              href="#features" 
